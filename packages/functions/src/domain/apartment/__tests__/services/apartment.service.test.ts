...
describe('ApartmentService', () => {
    ...
    describe('createApartment', () => {
        ...
        it('should throw error if apartment already exists', async () => {
            ...
            await expect(apartmentService.createApartment(createDto, 'admin'))
    ...
    describe('getApartmentDetails', () => {
        ...
        it('should throw error if apartment not found', async () => {
            ...
            await expect(apartmentService.getApartmentDetails('A999'))
                .rejects.toThrow(DomainError);
        });
    });
    ...
    describe('updateApartment', () => {
        ...
        it('should throw error if apartment not found', async () => {
            ...
            await expect(apartmentService.updateApartment('A999', updateDto, 'admin'))
                .rejects.toThrow(DomainError);
        });
    });
});