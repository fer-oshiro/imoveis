...
import { EntityNotFoundError, BusinessRuleViolationError, ValidationError } from '../../../shared/errors/domain-error';
...
describe('UserService', () => {
    ...
    describe('createUser', () => {
        ...
        it('should throw error if phone number already exists', async () => {
            ...
            await expect(userService.createUser(validUserData)).rejects.toThrow(BusinessRuleViolationError);
    ...
    describe('getUserByPhoneNumber', () => {
        ...
        it('should throw EntityNotFoundError when user not found', async () => {
            ...
            await expect(userService.getUserByPhoneNumber(validUserData.phoneNumber))
    ...
    describe('updateUser', () => {
        ...
        it('should throw error when user not found', async () => {
            ...
            await expect(userService.updateUser(validUserData.phoneNumber, { name: 'New Name' }))
                .rejects.toThrow(EntityNotFoundError);
        });
        ...
        it('should throw ValidationError for invalid update data', async () => {
            ...
            await expect(userService.updateUser(validUserData.phoneNumber, invalidUpdateData as any))
    ...
    describe('deleteUser', () => {
        ...
        it('should throw error when trying to delete active user', async () => {
            ...
            await expect(userService.deleteUser(validUserData.phoneNumber))
    ...
    describe('validateDocumentUnique', () => {
        ...
        it('should return true when document belongs to the same user being updated', async () => {
            ...
            const result = await userService.validateDocumentUnique('11144477735', validUserData.phoneNumber);
