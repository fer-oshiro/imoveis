...
export default function Home() {
  ...
  const handleCodeSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      if (!code || !session)
        throw new Error("Código ou sessão não podem ser vazios");
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 space-y-4 font-[family-name:var(--font-geist-sans)]">
      {step === 1 && (
        <FormPhone
          phone={phone}
          loading={loading}
