  ...
  implements IRelationshipRepository
{
  ...
  async findSpecificRelation(
    apartmentUnitCode: string,
    userPhoneNumber: string,
    role: UserRole,
  ): Promise<UserApartmentRelation | null> {
    try {
  ...
  async findByApartment(apartmentUnitCode: string): Promise<UserApartmentRelation[]> {
    try {
      ...
      throw new DatabaseError(
        `Failed to find relationships by apartment: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }

  async findByApartmentAndRole(
    apartmentUnitCode: string,
    role: UserRole,
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by apartment and role: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findActiveByApartment(apartmentUnitCode: string): Promise<UserApartmentRelation[]> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find active relationships by apartment: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findByUser(userPhoneNumber: string): Promise<UserApartmentRelation[]> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by user: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findActiveByUser(userPhoneNumber: string): Promise<UserApartmentRelation[]> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find active relationships by user: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findByUserAndRole(
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by user and role: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }

  async findByApartmentAndUser(
    apartmentUnitCode: string,
    userPhoneNumber: string,
  ): Promise<UserApartmentRelation[]> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by apartment and user: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findMultipleByApartments(apartmentUnitCodes: string[]): Promise<UserApartmentRelation[]> {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by multiple apartments: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async findMultipleByUsers(userPhoneNumbers: string[]): Promise<UserApartmentRelation[]> {
    ...
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to find relationships by multiple users: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
  ...
  async save(relationship: UserApartmentRelation): Promise<UserApartmentRelation> {
    try {
      ...
      const errorMessage = error instanceof Error ? error.message : 'Unknown error'
      throw new DatabaseError(
        `Failed to save relationship: ${errorMessage}`,
        error instanceof Error ? error : undefined,
      )
    }
  }
